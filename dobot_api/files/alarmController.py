...
This file (alarmController.py) is DEPRECATED as of version 4.1.0 and will be 
...
This file contains hardcoded controller alarm translations in a dictionary format.
...
warnings.warn(
    "alarmController.py is deprecated as of version 4.1.0 and will be removed in 5.0.0. "
